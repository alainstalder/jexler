image:jexler.jpg["jexler", link="https://www.artecat.ch/jexler/"]
...
Jexler uses https://www.artecat.ch/grengine/[Grengine] to run its container
of Groovy scripts and utility classes.

image:powered-by-grengine.gif["Powered by Grengine", link="https://www.artecat.ch/grengine/"]
